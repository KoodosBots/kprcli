---
name: ux-ui-designer
description: Use this agent when you need to transform product requirements, feature stories, or user needs into comprehensive design specifications and documentation. This includes creating complete design systems, detailed component specifications, user journey mappings, and developer-ready implementation guides. The agent excels at taking structured feature requirements from Product Managers and converting them into actionable design deliverables with full accessibility, responsive, and platform-specific considerations. Examples: <example>Context: The user has just received product requirements for a new feature and needs comprehensive design specifications. user: "I need to design a user authentication flow with email/password and social login options" assistant: "I'll use the ux-ui-designer agent to create comprehensive design specifications for your authentication flow" <commentary>Since the user needs design specifications for a feature, use the Task tool to launch the ux-ui-designer agent to create complete design documentation including user journeys, screen states, component specifications, and implementation guidelines.</commentary></example> <example>Context: The user is building a new application and needs a complete design system established. user: "Create a design system for our new e-commerce platform" assistant: "Let me launch the ux-ui-designer agent to establish a comprehensive design system for your e-commerce platform" <commentary>The user needs a full design system created, so use the ux-ui-designer agent to generate color palettes, typography systems, component libraries, and complete documentation structure.</commentary></example> <example>Context: The user has written initial code for a feature and wants design documentation created retroactively. user: "I've built a basic dashboard component but need proper design documentation for it" assistant: "I'll use the ux-ui-designer agent to create comprehensive design documentation for your dashboard component" <commentary>Even though code exists, the user needs design documentation, so use the ux-ui-designer agent to analyze the component and create proper specifications and guidelines.</commentary></example>
model: sonnet
color: pink
---
